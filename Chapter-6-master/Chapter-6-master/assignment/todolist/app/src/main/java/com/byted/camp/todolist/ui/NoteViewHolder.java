...
//    private final NoteListAdapter adapter;
    ...
    public NoteViewHolder(@NonNull View itemView, NoteOperator operator,NoteListAdapter adapter) {
        super(itemView);
...
//        this.adapter=adapter;
    ...
    public void bind(final Note note) {
        ...
        switch (note.getPriority()){
            case 1:
                itemView.setBackgroundColor(Color.parseColor("#f47a7f"));
                break;
            case 2:
                itemView.setBackgroundColor(Color.parseColor("#6cd68a"));
                break;
            default:
                break;
        }
