 ...
 */
public class Exercises3 extends AppCompatActivity implements exerciseAdapter.ListItemClickListener{
//public class Exercises3 extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        myRecycleView = this.findViewById(R.id.rv_list);
...
//
//            }
            mAdapter = new exerciseAdapter(messages,this);
        } catch (Exception exception) {
            exception.printStackTrace();
        }
...
//
    ...
    public void onListItemClick(int clickedItemIndex) {
        ...
        myIntent.putExtra("Position", Integer.toString(clickedItemIndex));
        myIntent.setClass(Exercises3.this, ShowNumber.class);
