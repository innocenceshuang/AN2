...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator scaleX=ObjectAnimator.ofFloat(TargetView,"scaleX",1f,2f);
        scaleX.setRepeatCount(ValueAnimator.INFINITE);
        scaleX.setInterpolator(new LinearInterpolator());
        scaleX.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        scaleX.setRepeatMode(ObjectAnimator.REVERSE);

        ObjectAnimator scaleY=ObjectAnimator.ofFloat(TargetView,"scaleY",1f,2f);
...
//
        ...
        ObjectAnimator alpha = ObjectAnimator.ofFloat(TargetView, "alpha", 1.0f, 0f);
